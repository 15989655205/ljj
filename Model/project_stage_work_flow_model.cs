...
{
    /// <summary>
    /// project_stage_work_flow_model:实体类(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class project_stage_work_flow_model
    {
        ...
        private string _work_flow_sid;
        private string _work_flowers;
        ...
        /// 
        /// </summary>
        public string work_flow_sid
        {
            set { _work_flow_sid = value; }
            get { return _work_flow_sid; }
        }
        /// <summary>
        /// 
        /// </summary>
        public string work_flowers
        {
            set { _work_flowers = value; }
            get { return _work_flowers; }
        }
        /// <summary>
        /// 
        /// </summary>
