...
{
	/// <summary>
	/// project_specific_item_model:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class project_specific_item_model
	{
		...
		private int? _appr_results;
		private string _recently_approver;
		private DateTime? _recently_date;
		...
		/// 
		/// </summary>
		public int? appr_results
		{
			set{ _appr_results=value;}
			get{return _appr_results;}
		}
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		public DateTime? recently_date
		{
			set{ _recently_date=value;}
			get{return _recently_date;}
		}
		/// <summary>
		/// 
		/// </summary>
