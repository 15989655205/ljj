...
namespace Maticsoft.DAL
{
	...
	public partial class project_implement
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("sid", "project_implement"); 
		}
		...
		public bool Exists(int sid)
		{
			...
			strSql.Append("select count(1) from project_implement");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.project_implement model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into project_implement(");
			strSql.Append("implement_name,s_sid,show_column,implementers_sid,implementers,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.project_implement model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update project_implement set ");
		...
		public bool Delete(int sid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from project_implement ");
			strSql.Append(" where sid=@sid");
			SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.project_implement GetModel(int sid)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 sid,implement_name,s_sid,show_column,implementers_sid,implementers,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date from project_implement ");
			strSql.Append(" where sid=@sid");
			SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
			...
			Maticsoft.Model.project_implement model=new Maticsoft.Model.project_implement();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.project_implement DataRowToModel(DataRow row)
		{
			Maticsoft.Model.project_implement model=new Maticsoft.Model.project_implement();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select sid,implement_name,s_sid,show_column,implementers_sid,implementers,dbo.getUserNames_fu(implementers_sid) as impUsers,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date ");
			strSql.Append(" FROM project_implement ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" sid,implement_name,s_sid,show_column,implementers_sid,implementers,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date ");
			strSql.Append(" FROM project_implement ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from project_implement T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "project_implement";
        ...
        public bool Edit(List<Model.project_implement> insertList, List<Model.project_implement> updateList, List<Model.project_implement> delList, List<Model.project_implement> sequenceList)
        {
            ...
            for (int i = 0; i < delList.Count; i++)
            {
                ...
                Model.project_implement model = delList[i];
                sbSql.Append("delete from project_implement where sid=" + model.sid);
            ...
            {
                sbSql = new StringBuilder();
                Model.project_implement model = updateList[i];
                sbSql.Append("update project_implement set implement_name = '" + model.implement_name.Trim() + "',");
                sbSql.Append("implementers_sid = '" + model.implementers_sid.Trim() + "',");
                sbSql.Append("implementers = '" + model.implementers.Trim() + "',");
                sbSql.Append("remark = '" + model.remark.Trim() + "',");
                sbSql.Append("v1='" + model.v1.Trim() + "'");
            ...
            {
                sbSql = new StringBuilder();
                Model.project_implement model = insertList[i];
                sbSql.Append("insert into project_implement(implement_name,implementers_sid,implementers, remark,s_sid,sequence,v1");
                sbSql.Append(")values(");
                sbSql.Append("'" + model.implement_name.Trim() + "','" + model.implementers_sid.Trim() + "','" + model.implementers.Trim() + "','" + model.remark.Trim() + "','" + model.s_sid + "'," + model.sequence+",'"+model.v1+"'");
                sbSql.Append(")");
                al.Add(sbSql.ToString());
            }
            ...
            {
                sbSql = new StringBuilder();
                Model.project_implement model = sequenceList[i];
                if (model.sid != null && model.sid.ToString().Trim() != "0" && model.sid.ToString().Trim() != "")
                {
                    sbSql.Append("update project_implement set sequence = " + model.sequence.ToString().Trim());
                    sbSql.Append(" where sid = " + model.sid.ToString().Trim() + "");
                    al.Add(sbSql.ToString());
                }
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select sid,implement_name,s_sid,show_column,implementers_sid,implementers,dbo.getUserNames_fu(implementers_sid) as impUserName,dbo.getUserAbbr_fu(implementers_sid) as impUserAbbr,v1,v2");
            strSql.Append(" FROM project_implement ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
