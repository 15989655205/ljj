...
namespace Maticsoft.DAL
{
	...
	public partial class ProductSeries
	{
		...
		public bool Exists(long ID)
		{
			...
			strSql.Append("select count(1) from ProductSeries");
		...
		public bool Delete(long ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ProductSeries ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.BigInt)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.ProductSeries GetModel(long ID)
		{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM ProductSeries ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from ProductSeries T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "ProductSeries";
