...
namespace Maticsoft.DAL
{
    ...
    /// 数据访问类:jxc_Payment
    /// </summary>
    public partial class jxc_Payment
    {
        public jxc_Payment()
        { }
        #region  BasicMethod
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from jxc_Payment");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Maticsoft.Model.jxc_Payment model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into jxc_Payment(");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Maticsoft.Model.jxc_Payment model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update jxc_Payment set ");
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from jxc_Payment ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public Maticsoft.Model.jxc_Payment GetModel(int ID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,Name,Directions,AuditDate,AuditGuy,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,status,create_person,create_date,update_person,update_date from jxc_Payment ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
            ...
            Maticsoft.Model.jxc_Payment model = new Maticsoft.Model.jxc_Payment();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Maticsoft.Model.jxc_Payment DataRowToModel(DataRow row)
        {
            Maticsoft.Model.jxc_Payment model = new Maticsoft.Model.jxc_Payment();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM jxc_Payment ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from jxc_Payment T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "jxc_Payment";
        ...
        public bool EditStock(List<Model.jxc_Payment> insertList, List<Model.jxc_Payment> updateList, List<Model.jxc_Payment> delList, long id)
        {
            ...
            for (int i = 0; i < delList.Count; i++)
            {
                ...
                Model.jxc_Payment model = delList[i];
                sbSql.Append("delete from jxc_Payment where ID=" + model.ID);
            ...
            {
                sbSql = new StringBuilder();
                Model.jxc_Payment model = updateList[i];
                sbSql.Append("update jxc_Payment set Name='" + model.Name + "',Directions='" + model.Directions + "',remark='" + model.remark + "'");
            ...
            {
                sbSql = new StringBuilder();
                Model.jxc_Payment model = insertList[i];
                sbSql.Append("insert into jxc_Payment(Name,Directions,remark,create_person,create_date) ");
                sbSql.Append("  values  ( ");
