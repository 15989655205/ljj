...
namespace Maticsoft.DAL
{
	...
	public partial class implement
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("sid", "implement"); 
		}
		...
		public bool Exists(int sid)
		{
			...
			strSql.Append("select count(1) from implement");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into implement(");
			strSql.Append("implement,s_sid,show_column,implementers_sid,implementers,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,show,show_name,status,create_person,create_date,update_person,update_date)");
			strSql.Append(" values (");
			strSql.Append("@implement,@s_sid,@show_column,@implementers_sid,@implementers,@remark,@v1,@v2,@v3,@v4,@v5,@v6,@v7,@v8,@v9,@v10,@show,@show_name,@status,@create_person,@create_date,@update_person,@update_date)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@implement", SqlDbType.NVarChar,100),
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update implement set ");
		...
		public bool Delete(int sid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from implement ");
			strSql.Append(" where sid=@sid");
			SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
		...
		public Maticsoft.Model.implement GetModel(int sid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 sid,implement,s_sid,show_column,implementers_sid,implementers,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,show,show_name,status,create_person,create_date,update_person,update_date from implement ");
			strSql.Append(" where sid=@sid");
			SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
			...
			Maticsoft.Model.implement model=new Maticsoft.Model.implement();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.implement DataRowToModel(DataRow row)
		{
			Maticsoft.Model.implement model=new Maticsoft.Model.implement();
			if (row != null)
			{
				...
				{
                    model.implement_name = row["implement"].ToString();
				}
				if(row["s_sid"]!=null)
				{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select sid,implement,s_sid,show_column,implementers_sid,implementers,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,show,show_name,status,create_person,create_date,update_person,update_date ");
			strSql.Append(" FROM implement ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" sid,implement,s_sid,show_column,implementers_sid,implementers,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,show,show_name,status,create_person,create_date,update_person,update_date ");
			strSql.Append(" FROM implement ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from implement T ");
