...
namespace Maticsoft.DAL
{
	...
	public partial class project_implementer
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("sid", "project_implementer"); 
		}
		...
		public bool Exists(int sid)
		{
			...
			strSql.Append("select count(1) from project_implementer");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into project_implementer(");
			strSql.Append("i_sid,show_column,implementers_sid,implementers,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update project_implementer set ");
		...
		public bool Delete(int sid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from project_implementer ");
			strSql.Append(" where sid=@sid");
			SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
		...
		public Maticsoft.Model.project_implementer GetModel(int sid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 sid,i_sid,show_column,implementers_sid,implementers,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date from project_implementer ");
			strSql.Append(" where sid=@sid");
			SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
			...
			Maticsoft.Model.project_implementer model=new Maticsoft.Model.project_implementer();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.project_implementer DataRowToModel(DataRow row)
		{
			Maticsoft.Model.project_implementer model=new Maticsoft.Model.project_implementer();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select sid,i_sid,show_column,implementers_sid,implementers,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date ");
			strSql.Append(" FROM project_implementer ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" sid,i_sid,show_column,implementers_sid,implementers,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date ");
			strSql.Append(" FROM project_implementer ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from project_implementer T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "project_implementer";
