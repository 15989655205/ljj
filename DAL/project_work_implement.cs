...
namespace Maticsoft.DAL
{
	...
	public partial class project_work_implement
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("sid", "project_work_implement"); 
		}
		...
		public bool Exists(int sid)
		{
			...
			strSql.Append("select count(1) from project_work_implement");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.project_work_implement model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into project_work_implement(");
			strSql.Append("psi_sid,imp_sid,implementer_sid,implementer,begin_date,end_date,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date)");
			strSql.Append(" values (");
			strSql.Append("@psi_sid,@imp_sid,@implementer_sid,@implementer,@begin_date,@end_date,@remark,@v1,@v2,@v3,@v4,@v5,@v6,@v7,@v8,@v9,@v10,@n1,@n2,@n3,@show,@show_name,@status,@create_person,@create_date,@update_person,@update_date)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@psi_sid", SqlDbType.NVarChar,50),
					new SqlParameter("@imp_sid", SqlDbType.NVarChar,50),
					new SqlParameter("@implementer_sid", SqlDbType.NVarChar,50),
					new SqlParameter("@implementer", SqlDbType.NVarChar,50),
			...
			parameters[0].Value = model.psi_sid;
			parameters[1].Value = model.imp_sid;
			parameters[2].Value = model.implementer_sid;
			parameters[3].Value = model.implementer;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.project_work_implement model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update project_work_implement set ");
			strSql.Append("psi_sid=@psi_sid,");
			strSql.Append("imp_sid=@imp_sid,");
			strSql.Append("implementer_sid=@implementer_sid,");
			strSql.Append("implementer=@implementer,");
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.project_work_implement GetModel(int sid)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 sid,psi_sid,imp_sid,implementer_sid,implementer,begin_date,end_date,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date from project_work_implement ");
			strSql.Append(" where sid=@sid");
			SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
			...
			Maticsoft.Model.project_work_implement model=new Maticsoft.Model.project_work_implement();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.project_work_implement DataRowToModel(DataRow row)
		{
			Maticsoft.Model.project_work_implement model=new Maticsoft.Model.project_work_implement();
			if (row != null)
			{
				...
				if(row["psi_sid"]!=null)
				{
					model.psi_sid=row["psi_sid"].ToString();
				}
				if(row["imp_sid"]!=null)
				{
					model.imp_sid=row["imp_sid"].ToString();
				}
				if(row["implementer_sid"]!=null)
				{
					model.implementer_sid=row["implementer_sid"].ToString();
				}
				if(row["implementer"]!=null)
				{
					model.implementer=row["implementer"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select sid,psi_sid,imp_sid,implementer_sid,implementer,begin_date,end_date,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date,dbo.getUserNames_fu(implementer_sid) as  implementers");
			strSql.Append(" FROM project_work_implement ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" sid,psi_sid,imp_sid,implementer_sid,implementer,begin_date,end_date,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date ");
			strSql.Append(" FROM project_work_implement ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from project_work_implement T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "project_work_implement";
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select sid,psi_sid,imp_sid,implementer_sid,implementer,begin_date,end_date,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date,dbo.getUserNames_fu(implementer_sid) as  implementers,dbo.getUserAbbr_fu(implementer_sid) as impUserAbbr");
            strSql.Append(" FROM project_work_implement ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
