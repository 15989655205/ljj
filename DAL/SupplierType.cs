...
namespace Maticsoft.DAL
{
	...
	public partial class SupplierType
	{
		...
		public bool Exists(long ID)
		{
			...
			strSql.Append("select count(1) from SupplierType");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SupplierType(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SupplierType set ");
		...
		public bool Delete(long ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SupplierType ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.BigInt)
			};
		...
		public int DeleteList(string IDlist )
		{
            ...
            strSql.Append("     and ID not in(select TypeID from Supplier group by TypeID)");
		...
		public Maticsoft.Model.SupplierType GetModel(long ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Code,Name,Enabled,Status,Remark,Value0,Value1,Value2,Value3,Value4,Value5,Value6,Value7,Value8,Value9,CreateUser,CreateDate,UpdateUser,UpdateDate from SupplierType ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.BigInt)
			};
			...
			Maticsoft.Model.SupplierType model=new Maticsoft.Model.SupplierType();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Code,Name,Enabled,Status,Remark,Value0,Value1,Value2,Value3,Value4,Value5,Value6,Value7,Value8,Value9,CreateUser,CreateDate,UpdateUser,UpdateDate ");
			strSql.Append(" FROM SupplierType ");
			if(strWhere.Trim()!="")
			{
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select ID value, '('+Code+')'+Name text ");
            strSql.Append(" from SupplierType ");
            return DbHelperSQL.Query(strSql.ToString());
        }
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,Code,Name,Enabled,Status,Remark,Value0,Value1,Value2,Value3,Value4,Value5,Value6,Value7,Value8,Value9,CreateUser,CreateDate,UpdateUser,UpdateDate ");
			strSql.Append(" FROM SupplierType ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SupplierType T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SupplierType";
