...
{
    /// <summary>
    /// 数据访问类:project_stage_work_flow_model
    /// </summary>
    public partial class project_stage_work_flow_model
    {
        ...
        public bool Exists(int sid)
        {
            ...
            strSql.Append("select count(1) from project_stage_work_flow_model");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into project_stage_work_flow_model(");
            strSql.Append("work_flow_name,s_sid,show_column,work_flow_sid,work_flowers,sequence,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date)");
            ...
            parameters[3].Value = model.work_flow_sid;
            parameters[4].Value = model.work_flowers;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update project_stage_work_flow_model set ");
        ...
        public bool Delete(int sid)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from project_stage_work_flow_model ");
            strSql.Append(" where sid=@sid");
            SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
        ...
        public Maticsoft.Model.project_stage_work_flow_model GetModel(int sid)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 sid,work_flow_name,s_sid,show_column,work_flow_sid,work_flowers,sequence,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date from project_stage_work_flow_model ");
            strSql.Append(" where sid=@sid");
            SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
            ...
            Maticsoft.Model.project_stage_work_flow_model model = new Maticsoft.Model.project_stage_work_flow_model();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Maticsoft.Model.project_stage_work_flow_model DataRowToModel(DataRow row)
        {
            Maticsoft.Model.project_stage_work_flow_model model = new Maticsoft.Model.project_stage_work_flow_model();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select sid,work_flow_name,s_sid,show_column,work_flow_sid,work_flowers,sequence,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date ");
            strSql.Append(" FROM project_stage_work_flow_model ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" sid,work_flow_name,s_sid,show_column,work_flow_sid,work_flowers,sequence,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date ");
            strSql.Append(" FROM project_stage_work_flow_model ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from project_stage_work_flow_model T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "project_stage_work_flow_model";
        ...
        public bool Edit(List<Model.project_stage_work_flow_model> insertList, List<Model.project_stage_work_flow_model> updateList, List<Model.project_stage_work_flow_model> delList, List<Model.project_stage_work_flow_model> sequenceList)
        {
            ...
            for (int i = 0; i < delList.Count; i++)
            {
                ...
                Model.project_stage_work_flow_model model = delList[i];
                sbSql.Append("delete from project_stage_work_flow_model where sid=" + model.sid);
            ...
            {
                sbSql = new StringBuilder();
                Model.project_stage_work_flow_model model = updateList[i];
                sbSql.Append("update project_stage_work_flow_model set work_flow_name = '" + model.work_flow_name.Trim() + "',");
            ...
            {
                sbSql = new StringBuilder();
                Model.project_stage_work_flow_model model = insertList[i];
                sbSql.Append("insert into project_stage_work_flow_model(work_flow_name,remark,s_sid,sequence");
                sbSql.Append(")values(");
                sbSql.Append("'" + model.work_flow_name.Trim() + "','" + model.remark.Trim() + "','" + model.s_sid + "'," + model.sequence);
                sbSql.Append(")");
                al.Add(sbSql.ToString());
            }
            ...
            {
                sbSql = new StringBuilder();
                Model.project_stage_work_flow_model model = sequenceList[i];
                if (model.sid != null && model.sid.ToString().Trim() != "0" && model.sid.ToString().Trim() != "")
                {
                    sbSql.Append("update project_stage_work_flow_model set sequence = " + model.sequence.ToString().Trim());
                    sbSql.Append(" where sid = " + model.sid.ToString().Trim() + "");
                    al.Add(sbSql.ToString());
                }
            }
