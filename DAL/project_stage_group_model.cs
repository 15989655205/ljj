/**  版本信息模板在安装目录下，可自行修改。
* project_stage_group_model.cs
*
* 功 能： N/A
* 类 名： project_stage_group_model
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
...
{
	/// <summary>
	/// 数据访问类:project_stage_group_model
	/// </summary>
	public partial class project_stage_group_model
	{
		public project_stage_group_model()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("sid", "project_stage_group_model"); 
		}
		...
		public bool Exists(int sid)
		{
			...
			strSql.Append("select count(1) from project_stage_group_model");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.project_stage_group_model model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into project_stage_group_model(");
			strSql.Append("deptid,group_name,ps_sid,show_column,sequence,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@ps_sid", SqlDbType.NVarChar,50),
			...
			parameters[2].Value = model.ps_sid;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.project_stage_group_model model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update project_stage_group_model set ");
			strSql.Append("deptid=@deptid,");
			strSql.Append("group_name=@group_name,");
			strSql.Append("ps_sid=@ps_sid,");
		...
		public bool Delete(int sid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from project_stage_group_model ");
			strSql.Append(" where sid=@sid");
			SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.project_stage_group_model GetModel(int sid)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 sid,deptid,group_name,ps_sid,show_column,sequence,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date from project_stage_group_model ");
			strSql.Append(" where sid=@sid");
			SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
			...
			Maticsoft.Model.project_stage_group_model model=new Maticsoft.Model.project_stage_group_model();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.project_stage_group_model DataRowToModel(DataRow row)
		{
			Maticsoft.Model.project_stage_group_model model=new Maticsoft.Model.project_stage_group_model();
			if (row != null)
			{
				...
				if(row["ps_sid"]!=null)
				{
					model.ps_sid=row["ps_sid"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select sid,deptid,group_name,ps_sid,show_column,sequence,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date ");
			strSql.Append(" FROM project_stage_group_model ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" sid,deptid,group_name,ps_sid,show_column,sequence,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date ");
			strSql.Append(" FROM project_stage_group_model ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from project_stage_group_model T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "project_stage_group_model";
        ...
        public bool Edit(List<Model.project_stage_group_model> insertList, List<Model.project_stage_group_model> updateList, List<Model.project_stage_group_model> delList, List<Model.project_stage_group_model> sequenceList)
        {
            ...
            for (int i = 0; i < delList.Count; i++)
            {
                ...
                Model.project_stage_group_model model = delList[i];
                sbSql.Append("delete from project_stage_group_model where sid=" + model.sid);
            ...
            {
                sbSql = new StringBuilder();
                Model.project_stage_group_model model = updateList[i];
                sbSql.Append("update project_stage_group_model set group_name = '" + model.group_name.Trim() + "',");
            ...
            {
                sbSql = new StringBuilder();
                Model.project_stage_group_model model = insertList[i];
                sbSql.Append("insert into project_stage_group_model(group_name, remark,ps_sid,sequence");
                sbSql.Append(")values(");
                sbSql.Append("'" + model.group_name.Trim() + "','" + model.remark.Trim() + "','" + model.ps_sid + "'," + model.sequence);
                sbSql.Append(")");
                al.Add(sbSql.ToString());
            }
            ...
            {
                sbSql = new StringBuilder();
                Model.project_stage_group_model model = sequenceList[i];
                if (model.sid != null && model.sid.ToString().Trim() != "0" && model.sid.ToString().Trim() != "")
                {
                    sbSql.Append("update project_stage_group_model set sequence = " + model.sequence.ToString().Trim());
                    sbSql.Append(" where sid = " + model.sid.ToString().Trim() + "");
                    al.Add(sbSql.ToString());
                }
            }
