...
namespace Maticsoft.DAL
{
    ...
    /// 数据访问类:jxc_Transport
    /// </summary>
    public partial class jxc_Transport
    {
        public jxc_Transport()
        { }
        #region  BasicMethod
        /// <summary>
        /// 是否存在该记录
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from jxc_Transport");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Maticsoft.Model.jxc_Transport model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into jxc_Transport(");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Maticsoft.Model.jxc_Transport model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update jxc_Transport set ");
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from jxc_Transport ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public Maticsoft.Model.jxc_Transport GetModel(int ID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,Name,Directions,AuditDate,AuditGuy,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,status,create_person,create_date,update_person,update_date from jxc_Transport ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
            ...
            Maticsoft.Model.jxc_Transport model = new Maticsoft.Model.jxc_Transport();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Maticsoft.Model.jxc_Transport DataRowToModel(DataRow row)
        {
            Maticsoft.Model.jxc_Transport model = new Maticsoft.Model.jxc_Transport();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM jxc_Transport ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from jxc_Transport T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "jxc_Transport";
        ...
        public bool EditStock(List<Model.jxc_Transport> insertList, List<Model.jxc_Transport> updateList, List<Model.jxc_Transport> delList, long id)
        {
            ...
            for (int i = 0; i < delList.Count; i++)
            {
                ...
                Model.jxc_Transport model = delList[i];
                sbSql.Append("delete from jxc_Transport where ID=" + model.ID);
            ...
            {
                sbSql = new StringBuilder();
                Model.jxc_Transport model = updateList[i];
                sbSql.Append("update jxc_Transport set Name='" + model.Name + "',Directions='" + model.Directions + "',remark='" + model.remark + "'");
            ...
            {
                sbSql = new StringBuilder();
                Model.jxc_Transport model = insertList[i];
                sbSql.Append("insert into jxc_Transport(Name,Directions,remark,create_person,create_date) ");
                sbSql.Append("  values  ( ");
