...
namespace Maticsoft.DAL
{
    ...
    public partial class construct
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from construct");
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from construct ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,fw_sid,imp_sid,imp_name,begin_time,end_time,SN,fw_name,value1,value2,value3,value4,n1,n2,n3,n4 ");
            strSql.Append(" FROM construct ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,fw_sid,imp_sid,imp_name,begin_time,end_time,SN,fw_name,value1,value2,value3,value4,n1,n2,n3,n4 ");
            strSql.Append(" FROM construct ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from construct T ");
