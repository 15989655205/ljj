...
namespace Maticsoft.DAL
{
    ...
    public partial class jxc_InvoiceType
    {
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from jxc_InvoiceType");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Maticsoft.Model.jxc_InvoiceType model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into jxc_InvoiceType(");
            strSql.Append("Name,Directions,AuditDate,AuditGuy,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,status,create_person,create_date,update_person,update_date)");
            ...
            parameters[1].Value = model.Directions;
            parameters[2].Value = model.AuditDate;
            parameters[3].Value = model.AuditGuy;
            ...
            parameters[19].Value = model.create_person;
            parameters[20].Value = model.create_date;
            parameters[21].Value = model.update_person;
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Maticsoft.Model.jxc_InvoiceType model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update jxc_InvoiceType set ");
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from jxc_InvoiceType ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public Maticsoft.Model.jxc_InvoiceType GetModel(int ID)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,Name,Directions,AuditDate,AuditGuy,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,status,create_person,create_date,update_person,update_date from jxc_InvoiceType ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
            ...
            Maticsoft.Model.jxc_InvoiceType model = new Maticsoft.Model.jxc_InvoiceType();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Maticsoft.Model.jxc_InvoiceType DataRowToModel(DataRow row)
        {
            Maticsoft.Model.jxc_InvoiceType model = new Maticsoft.Model.jxc_InvoiceType();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,Name,Directions,AuditDate,AuditGuy,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,status,create_person,create_date,update_person,update_date ");
            strSql.Append(" FROM jxc_InvoiceType ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,Name,Directions,AuditDate,AuditGuy,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,status,create_person,create_date,update_person,update_date ");
            strSql.Append(" FROM jxc_InvoiceType ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from jxc_InvoiceType T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "jxc_InvoiceType";
        ...
        public bool EditStock(List<Model.jxc_InvoiceType> insertList, List<Model.jxc_InvoiceType> updateList, List<Model.jxc_InvoiceType> delList, long id)
        {
            ...
            for (int i = 0; i < delList.Count; i++)
            {
                ...
                Model.jxc_InvoiceType model = delList[i];
                sbSql.Append("delete from jxc_InvoiceType where ID=" + model.ID);
            ...
            {
                sbSql = new StringBuilder();
                Model.jxc_InvoiceType model = updateList[i];
                sbSql.Append("update jxc_InvoiceType set Name='" + model.Name + "',Directions='" + model.Directions + "',remark='" + model.remark + "'");
            ...
            {
                sbSql = new StringBuilder();
                Model.jxc_InvoiceType model = insertList[i];
                sbSql.Append("insert into jxc_InvoiceType(Name,Directions,remark,create_person,create_date) ");
                sbSql.Append("  values  ( ");
                sbSql.Append("'" + model.Name + "','" + model.Directions + "','" + model.remark + "','" + id + "',getdate()");
                sbSql.Append(" ) ");
                arr.Add(sbSql.ToString());
            }
