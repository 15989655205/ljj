...
namespace Maticsoft.DAL
{
	...
	public partial class project_group_model
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("sid", "project_group_model"); 
		}
		...
		public bool Exists(int sid)
		{
			...
			strSql.Append("select count(1) from project_group_model");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into project_group_model(");
			strSql.Append("deptid,group_name,ps_sid,show_column,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date)");
			...
			parameters[15].Value = model.n1;
			parameters[16].Value = model.n2;
			parameters[17].Value = model.n3;
			parameters[18].Value = model.show;
			parameters[19].Value = model.show_name;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update project_group_model set ");
		...
		public bool Delete(int sid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from project_group_model ");
			strSql.Append(" where sid=@sid");
			SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
		...
		public Maticsoft.Model.project_group_model GetModel(int sid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 sid,deptid,group_name,ps_sid,show_column,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date from project_group_model ");
			strSql.Append(" where sid=@sid");
			SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
			...
			Maticsoft.Model.project_group_model model=new Maticsoft.Model.project_group_model();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.project_group_model DataRowToModel(DataRow row)
		{
			Maticsoft.Model.project_group_model model=new Maticsoft.Model.project_group_model();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select sid,deptid,group_name,ps_sid,show_column,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date ");
			strSql.Append(" FROM project_group_model ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" sid,deptid,group_name,ps_sid,show_column,remark,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,n1,n2,n3,show,show_name,status,create_person,create_date,update_person,update_date ");
			strSql.Append(" FROM project_group_model ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from project_group_model T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "project_group_model";
        ...
        public bool Edit(List<Model.project_group_model> insertList, List<Model.project_group_model> updateList, List<Model.project_group_model> delList)
        {
            ...
            for (int i = 0; i < delList.Count; i++)
            {
                ...
                Model.project_group_model model = delList[i];
                sbSql.Append("delete from project_group_model where sid=" + model.sid);
            ...
            {
                sbSql = new StringBuilder();
                Model.project_group_model model = updateList[i];
                sbSql.Append("update project_group_model set group_name = '" + model.group_name.Trim() + "',");
                sbSql.Append("remark = '" + model.remark.Trim() + "'");
                sbSql.Append("create_person='" + model.update_person + "'");
                sbSql.Append("create_date='" + model.update_date + "'");
            ...
            {
                sbSql = new StringBuilder();
                Model.project_group_model model = insertList[i];
                sbSql.Append("insert into project_group_model(group_name, remark,create_person,create_date");
                sbSql.Append(")values(");
                sbSql.Append("'" + model.group_name.Trim() + "','" + model.remark.Trim() + "','"+model.create_person+"','"+model.create_date+"'");
                sbSql.Append(")");
                al.Add(sbSql.ToString());
            }
        ...
        #region  ExtensionMethod
        public bool Edit(List<Model.project_group_model> insertList, List<Model.project_group_model> updateList, List<Model.project_group_model> delList, string uid)
        {
            ArrayList al = new ArrayList();
            StringBuilder sbSql = new StringBuilder();
            //删除
            ...
            for (int i = 0; i < insertList.Count; i++)
            {
                ...
                sbSql.Append("insert into project_group_model(group_name, remark,create_person,create_date");
                sbSql.Append(")values(");
                sbSql.Append("'" + model.group_name.Trim() + "','" + model.remark.Trim() + "','" + uid + "',getdate()");
                sbSql.Append(")");
                al.Add(sbSql.ToString());
            }
