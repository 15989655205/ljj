...
namespace Maticsoft.DAL
{
	...
	public partial class node_type
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("sid", "node_type"); 
		}
		...
		public bool Exists(int sid)
		{
			...
			strSql.Append("select count(1) from node_type");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.node_type model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into node_type(");
			strSql.Append("node_type_name,remark,value1,value2,value3,value4,value5,value6,status,create_person,create_date,update_person,update_date)");
			strSql.Append(" values (");
			strSql.Append("@node_type_name,@remark,@value1,@value2,@value3,@value4,@value5,@value6,@status,@create_person,@create_date,@update_person,@update_date)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@node_type_name", SqlDbType.NVarChar,10),
			...
			parameters[0].Value = model.node_type_name;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.node_type model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update node_type set ");
			strSql.Append("node_type_name=@node_type_name,");
		...
		public bool Delete(int sid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from node_type ");
			strSql.Append(" where sid=@sid");
			SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.node_type GetModel(int sid)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 sid,node_type_name,remark,value1,value2,value3,value4,value5,value6,status,create_person,create_date,update_person,update_date from node_type ");
			strSql.Append(" where sid=@sid");
			SqlParameter[] parameters = {
					new SqlParameter("@sid", SqlDbType.Int,4)
			};
			...
			Maticsoft.Model.node_type model=new Maticsoft.Model.node_type();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.node_type DataRowToModel(DataRow row)
		{
			Maticsoft.Model.node_type model=new Maticsoft.Model.node_type();
			if (row != null)
			{
				...
				if(row["node_type_name"]!=null)
				{
					model.node_type_name=row["node_type_name"].ToString();
				}
				if(row["remark"]!=null)
				{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select sid,node_type_name,remark,value1,value2,value3,value4,value5,value6,status,create_person,create_date,update_person,update_date ");
			strSql.Append(" FROM node_type ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" sid,node_type_name,remark,value1,value2,value3,value4,value5,value6,status,create_person,create_date,update_person,update_date ");
			strSql.Append(" FROM node_type ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from node_type T ");
