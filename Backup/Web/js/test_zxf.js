var groupview = $.extend({}, $.fn.datagrid.defaults.view, {
    render: function (target, container, frozen) {
        ...
        for (var i = 0; i < groups.length; i++) {
            ...
            if (!frozen) {
                table.push('<span onclick="test1(' + i + ')" id="datagrid-span-' + i + '" style="width: 16px; display: inline-block; height: 16px; cursor: pointer;" class="datagrid-row-expander datagrid-row-expand"></span><span style="color:#416aa3;font-weight:bold;margin-left:10px;">');
            ...
            table.push('<table class="datagrid-btable-' + i + '" cellspacing="0" style="display:none" cellpadding="0" border="0"><tbody>');
