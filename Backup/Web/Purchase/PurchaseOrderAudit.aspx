<%@ Page Title="" Language="C#" MasterPageFile="~/easyui.Master" AutoEventWireup="true" CodeBehind="PurchaseOrderAudit.aspx.cs" Inherits="Maticsoft.Web.Purchase.PurchaseOrderAudit" %>
...
<script src="../js/com-datagrid.js" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        var datagridURL = "/Ashx/Pruchase.ashx?action=PruchaseOrderAuditList";
        var params = { 'status': 2 };
        ...
        function sh() {
            ...
            url = "/Purchase/PurchaseOrderItem.aspx?action=audit&sid=" + row.ID;
            parent.addTab_Ext('订货单' + row.Code + '【审核】', url, "", true);
        }
        ...
        function view() {
            ...
            parent.addTab_Ext('订货单'+row.Code+'【查看】', url, "", true);
        }
