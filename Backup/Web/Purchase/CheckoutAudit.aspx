<%@ Page Title="" Language="C#" MasterPageFile="~/easyui.Master" AutoEventWireup="true" CodeBehind="CheckoutAudit.aspx.cs" Inherits="Maticsoft.Web.Purchase.CheckoutAudit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 <script src="../js/com-datagrid.js" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        var datagridURL = "/Ashx/Pruchase.ashx?action=CheckoutAuditList";
        var params = { 'status': 2 };
        ...
        function sh() {
            ...
            if (selected.length > 0) {
                $.post("/Ashx/Pruchase.ashx", { "action": "CheckoutAudit", "type": "pass", "selects": selected }, function (data) {
                    $("#tt").datagrid("reload");
        ...
        function np() {
            ...
            selected = selected.substr(0, selected.length - 1);
            if (selected.length > 0) {
                $.post("/Ashx/Pruchase.ashx", { "action": "CheckoutAudit", "type": "nopass", "selects": selected }, function (data) {
                    $("#tt").datagrid("reload");
                    $.messager.show({ title: "系统提示", msg: data });
                });
            }
