<%@ Page Title="" Language="C#" MasterPageFile="~/easyui.Master" AutoEventWireup="true" CodeBehind="SupplierType.aspx.cs" Inherits="Maticsoft.Web.BaseInfo.SupplierType" %>
<%@ Register TagPrefix="toolbar" TagName="ToolBar" Src="../Controls/Toolbar.ascx" %>
<%@ Register TagPrefix="st" TagName="ST" Src="../Controls/BaseInfo/SupplierType.ascx" %>
    ...
    <script type="text/javascript">
        ...
        function del() {
            ...
            $.messager.confirm("提示", "确认删除？", function (r) {
                if (r) {
                    $.post("../Ashx/SupplierType.ashx", { "action": "dels", "cbx_select": selected }, function (data) {
                        $("#tt").datagrid("reload");
