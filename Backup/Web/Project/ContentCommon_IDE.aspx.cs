...
{
    public partial class ContentCommon_IDE : System.Web.UI.Page
    {
        protected string sid = "", pssid = "", pname = "", pcode = "", stageName = "", column = "", frozencolumns="",psid = "", sDateStr = "", eDateStr = "";
        protected string showContent = "", showItem = "", isConstruction = "", showContentPro="";
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                 isConstruction = Request["isConstruction"];
                ...
                //    //}
                //    //dnyV2 = ",{title: '',field:'v2',width:80, halign:'center', align:'center',formatter:function(value,row){return row.finaler;},editor:{type:'combobox', options: { data: " + user + ", valueField: 'UserName', editable: false, textField: 'Name',required: true, missingMessage: '必填',onLoadSuccess:function(){$(this).combobox('getValue','" + dt.Rows[0]["v2"].ToString().Trim() + "')}}}}";
