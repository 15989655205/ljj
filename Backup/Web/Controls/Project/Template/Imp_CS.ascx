<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Imp_CS.ascx.cs" Inherits="Maticsoft.Web.Controls.Project.Template.Imp_CS" %>
<script type="text/javascript">
    ...
    function imp_EditRow(index) {
        if (imp_editIndex != index) {
            if (imp_endEditing()) {
                ...
                var editor = $('#imp_tt').datagrid('getEditor', { index: index, field: 'implement_name' });
    ...
    function imp_MoveRow(fx) {
        ...
        var editor = $('#imp_tt').datagrid('getEditor', { index: iMovedRowIndex, field: 'implement_name' });
        $(editor.target).attr('disabled', true);
