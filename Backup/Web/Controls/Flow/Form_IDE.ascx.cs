...
namespace Maticsoft.Web.Controls.Flow
{
    public partial class Form_IDE : System.Web.UI.UserControl
    {
        protected string type = "";
        protected string sid = "";
        protected bool isSave = true;
        protected Model.request_form formModel = new Model.request_form();
