<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SupplierType.ascx.cs" Inherits="Maticsoft.Web.Controls.BaseInfo.SupplierType" %>
...
<script type="text/javascript">
    function openDialog(type, row, title) {
        switch (type) {
            case "add": sumbitUrl = "../Ashx/SupplierType.ashx?action=add"; ClearControl(); break;
            case "copy": sumbitUrl = "../Ashx/SupplierType.ashx?action=add"; showData(row); break;
            case "edit": sumbitUrl = "../Ashx/SupplierType.ashx?action=edit"; showData(row); break;
