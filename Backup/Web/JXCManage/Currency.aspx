<%@ Page Title="" Language="C#" MasterPageFile="~/easyui.Master" AutoEventWireup="true" CodeBehind="Currency.aspx.cs" Inherits="Maticsoft.Web.BaseInfo.Currency" %>
 ...
 <table id="dg"></table>
          <script type="text/javascript">
              function LoadTable() {
                  var editIndex;
                  $('#dg').datagrid({
                      url: '../Ashx/StockMessage.ashx?action=list1',
                      loadMsg: "正在努力加载中..."
                , toolbar: "#tab_toolbar"
                , idField: "ID"
                , pageSize: 10
                ...
                , singleSelect: true,
                      columns: [[
        { field: 'Name', title: '货币名称', width: 150, editor: "text" },
        { field: 'Code', title: '货币代号', width: 150, editor: "text" },
        { field: 'ExchangeRate', title: '汇率', width: 150, editor: "text" },
