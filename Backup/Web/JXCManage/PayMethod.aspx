<%@ Page Title="" Language="C#" MasterPageFile="~/easyui.Master" AutoEventWireup="true" CodeBehind="PayMethod.aspx.cs" Inherits="Maticsoft.Web.JXCManage.PayMethod" %>
        ...
        LoadTable();
          ...
          <script type="text/javascript">
              function LoadTable() {
                  var editIndex;
                  $('#dg').datagrid({
                      url: '../Ashx/StockMessage.ashx?action=list2',
                      loadMsg: "正在努力加载中..."
                , toolbar: "#tab_toolbar"
                , idField: "ID"
                , pageSize: 10
                ...
                , singleSelect: true,
                      columns: [[
        { field: 'Name', title: '付款方式名称', width: 150, editor: "text" },
