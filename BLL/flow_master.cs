...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.flow_master dal=new Maticsoft.DAL.flow_master();
		public flow_master()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.flow_master GetModelByCache(int sid)
		{
			
			string CacheKey = "flow_masterModel-" + sid;
			...
			return (Maticsoft.Model.flow_master)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.flow_master> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.flow_master> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.flow_master> modelList = new List<Maticsoft.Model.flow_master>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.flow_master model;
        ...
        public string DeleteFlow(string SID)
        {
            if (dal.DeleteFlow(SID))
            {
                return "success";
            }
            else
