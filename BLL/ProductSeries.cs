...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.ProductSeries dal=new Maticsoft.DAL.ProductSeries();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.ProductSeries GetModelByCache(long ID)
		{
			
			string CacheKey = "ProductSeriesModel-" + ID;
			...
			return (Maticsoft.Model.ProductSeries)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.ProductSeries> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.ProductSeries> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.ProductSeries> modelList = new List<Maticsoft.Model.ProductSeries>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.ProductSeries model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Maticsoft.Model.ProductSeries();
