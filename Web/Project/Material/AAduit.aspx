<%@ Page Title="" Language="C#" MasterPageFile="~/easyui.Master" AutoEventWireup="true"
    CodeBehind="AAduit.aspx.cs" Inherits="Maticsoft.Web.Project.Material.AAduit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    function LoadedBar(){
        ...
        if(document.getElementById('tab_div_10').style.display!='none'){
            where+="(Submit=1 and Audit=0 or Audit=1)";
        }
...
//    }
    ...
    function LoadTable(where) {
        $("#tt").datagrid({
            url: "/Ashx/ProjectMaterial.ashx?action=MaterialAAduitList"
