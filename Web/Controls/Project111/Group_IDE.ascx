<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Group_IDE.ascx.cs" Inherits="Maticsoft.Web.Controls.Project111.Group_IDE" %>
<script type="text/javascript">
    ...
    function group_Left() {
        $('#group_left').tree({
            url: '../Ashx/Project.ashx?action=groupList',
