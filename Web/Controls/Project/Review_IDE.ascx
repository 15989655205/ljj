<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Review_IDE.ascx.cs" Inherits="Maticsoft.Web.Controls.Project.Review_IDE" %>
...
<script type="text/javascript">
    ...
    function combogridload() {
        document.getElementById('div_cc').innerHTML = '<input id="cc" name="cc" style="width:300px;"/>';
        $('#cc').combogrid({
            ...
            //fitColumns: true,
            columns: [[
				{ title: '目录名', field: 'folder_name', width: 180 },
                { title: '完整目录', field: 'folderpath', width: 800 },
			]],
