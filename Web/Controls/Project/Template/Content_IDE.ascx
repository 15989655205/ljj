<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Content_IDE.ascx.cs" Inherits="Maticsoft.Web.Controls.Project.Template.Content_IDE" %>
...
//        // submit the form   
        ...
        $.ajax({
            ...
            url: '../../Ashx/projectStage.ashx?action=' + action + '&type=' + showType,
            data: dataJson,
            success: function (data) {
                if (data == "success") {
                    $('#tt').datagrid("reload");
       ...
       <tr>
        ...
        <tr>
            ...
            <td style="background-color: #ffffff; height: 25px; padding-left: 5px;">
                ...
                <textarea id="pw_name" name="pw_name" rows="3" cols="10" class="easyui-validatebox"  style="width: 95%;"></textarea>*
            </td>
        </tr>
