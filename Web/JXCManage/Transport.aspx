<%@ Page Title="" Language="C#" MasterPageFile="~/easyui.Master" AutoEventWireup="true" CodeBehind="Transport.aspx.cs" Inherits="Maticsoft.Web.JXCManage.Transport" %>
        ...
        LoadTable();
          ...
          <script type="text/javascript">
              function LoadTable() {
                  var editIndex;
                  $('#dg').datagrid({
                      url: '../Ashx/StockMessage.ashx?action=list3',
                      loadMsg: "正在努力加载中..."
                , toolbar: "#tab_toolbar"
                , idField: "ID"
                , pageSize: 10
                ...
                , singleSelect: true,
                      columns: [[
        { field: 'Name', title: '送货方式', width: 150, editor: "text" },
