<%@ Page Title="" Language="C#" MasterPageFile="~/easyui.Master" AutoEventWireup="true" CodeBehind="StockMessage.aspx.cs" Inherits="Maticsoft.Web.BaseInfo.StockMessage" %>
        ...
        LoadTable();
          ...
          <script type="text/javascript">
              function LoadTable() {
                  var editIndex;
                  $('#dg').datagrid({
                      url: '../Ashx/StockMessage.ashx?action=list',
                      loadMsg: "正在努力加载中..."
                , toolbar: "#tab_toolbar"
                , idField: "ID"
                , pageSize: 10
                ...
                , singleSelect: true,
                      columns: [[
        { field: 'StockNo', title: '仓库编号', width: 150, editor: "text" },
        { field: 'StockName', title: '仓库名称', width: 150, editor: "text" },
        { field: 'StockPoint', title: '仓库地点', width: 150, editor: "text" },
