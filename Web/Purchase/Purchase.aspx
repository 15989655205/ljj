<%@ Page Title="" Language="C#" MasterPageFile="~/easyui.Master" AutoEventWireup="true" CodeBehind="Purchase.aspx.cs" Inherits="Maticsoft.Web.Purchase.Purchase" %>
...
<script src="../js/com-datagrid.js" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        var columns = [[
         ...
         { title: '送货单号', field: 'DeliveryDate', width: 80, halign: 'center' },
        ...
        var datagridURL = "/Ashx/Pruchase.ashx?action=PruchaseList";
        ...
        function edit() {
            ...
            url = "/Purchase/PurchaseItem.aspx?action=edit&sid=" + row.ID;
            parent.addTab_Ext('进货单【编辑】' + row.Code + '', url, "", true);
        }
        ...
        function Sumbit() {
            ...
            if (selected.length > 0) {
                $.post("../Ashx/Pruchase.ashx", { "action": "PruchaseSubmit", "selects": selected }, function (data) {
                    $("#tt").datagrid("reload");
