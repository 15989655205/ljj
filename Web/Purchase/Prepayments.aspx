<%@ Page Title="" Language="C#" MasterPageFile="~/easyui.Master" AutoEventWireup="true" CodeBehind="Prepayments.aspx.cs" Inherits="Maticsoft.Web.Purchase.Prepayments" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        var datagridURL = "/Ashx/Pruchase.ashx?action=PrePaymentList";
        ...
        function save() {
            GridSave("/Ashx/Pruchase.ashx", "PrePaymentSave");
        }
        ...
        function Sumbit() {
            ...
            if (selected.length > 0) {
                $.post("/Ashx/Pruchase.ashx", { "action": "PrePaymentSubmit", "selects": selected }, function (data) {
                    $("#tt").datagrid("reload");
